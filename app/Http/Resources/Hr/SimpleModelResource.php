...
{
    private const LOOKUP_RELATIONS = ['status', 'outcomeStatus', 'position', 'employmentType', 'disposition'];

    private const SUMMARY_RELATIONS = ['candidate' => 'full_name', 'recommendedCandidate' => 'full_name'];
